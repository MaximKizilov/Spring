...
public class JavaConfig {
    @Bean
    @ConditionalOnProperty(value = "ru.netology.profile.dev", name = "dev", havingValue = "true")
    public SystemProfile devProfile() {
        return new DevProfile();
    }

    @Bean
    @ConditionalOnProperty(value = "ru.netology.profile", name = "dev", havingValue = "false")
